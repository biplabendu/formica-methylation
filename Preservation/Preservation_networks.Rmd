...
### Input both datasets
```{r preservation1}
setwd("/Users/biplabendudas/Documents/GitHub/formica-methylation/Preservation/")
...
```{r calculation1}
setLabels = c("Met", "Exp");
multiExpr = list(Exp = list(data = datExpr), 
                 Met = list(data = datMet));
multiColor = list(Exp = colorsExp); ## what about colorsMet? 
...
```{r display1}
load(file = "modulePreservation_metExp.RData")
ref = 1
test = 2
...
load(file = "modulePreservation_metExp_reverse.RData");
```
...
load(file = "modulePreservation_OldExp.RData");
```
